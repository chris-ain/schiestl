...
function init() {
  ...
  for (var i = 0; i < 50; i++) {
    ...
    mesh1.scale.x = mesh1.scale.y = mesh1.scale.z = Math.random() * .5;
  ...
  for (var i = 0; i < 1000; i++) {
    ...
    mesh2.scale.x = mesh2.scale.y = mesh2.scale.z = Math.random() * .9;
    particle.add(mesh2);
  }
        ...
        //
				...
				// const effectBloom = new BloomPass( .0 );
				// const effectFilm = new FilmPass( 0.2, 0.2, 2048, false );
...
object.rotation.y += 0.00030;
particle.rotation.x += 0.000030;
...
for (mesh2 of particle.children) {
    if (mesh2.geometry instanceof THREE.TetrahedronGeometry) {
        mesh2.rotation.x += Math.random()*.003;
        mesh2.rotation.y += Math.random()*.003;
  ...
  for (mesh1 of particle.children) {
    if (mesh1.geometry instanceof THREE.TetrahedronGeometry) {
        mesh1.rotation.x += Math.random()*.03;
        mesh1.rotation.y += Math.random()*.03;
